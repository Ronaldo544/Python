...
class Button():
    ...
    def clicked(self, pos):
        ...
        if self.pos[0] > self.y and self.pos[1] < self.y + self.height:
            return True
        return False
...
class RpsGame():
    def __init__(self):
        ...
        self.font = pygame.font.Font(('Splatch.tff'), 90)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.rock_btn.clicked(30) or self.paper_btn.clicked(340) or self.scissors_btn.clicked(640):
                        ...
                        self.text = self.font.render(f"{self.pl_score} :{self.pc_score}", True, (225,225,225))
